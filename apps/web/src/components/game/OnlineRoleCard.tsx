...
export function OnlineRoleCard({
  playerName,
  role,
  word,
  hint,
            ...
            >
              ...
              {isImpostor ? (
                <div className="flex flex-col gap-2 mt-4">
                  ...
                  <p className="font-display text-2xl font-bold text-white">{hint ?? 'No hint'}</p>
                  <p className="text-[10px] font-bold uppercase tracking-[0.1em] text-danger mt-2">
